...
import NewBalanceProducts from './data/NewBalanceProducts';
import { useNavigation } from '@react-navigation/native';
import { ScrollView } from 'react-native-gesture-handler';

const newbalance = NewBalanceProducts;
...
const ShoeList = () => {
  ...
  const renderSelectedShoeDetails = () => {
    if (selectedShoe) {
      const selectedShoeData = newbalance.find((shoe) => shoe.name === selectedShoe);
      return (
